...
Heart.Bye.prototype = {
	...
	create: function() {
	    ...
	    this.game.add.text((this.game.world.width - 200)/2,20,
	    	"Thanks for playing! Sent " + gAmount.toFixed(1) + " to your address. Click the button below to view the transaction in the block explorer (Note that it takes a few minutes to show up)",
